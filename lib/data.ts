...
export const SCHOOLS: School[] = [
  ...
  { id: 'sunrise', name: 'Sunrise Montessori', tagline: 'A joyful start to learning', location: 'Maitama, Abuja', type: 'Primary', gender: 'Mixed', boarding: 'Day', feeFromKobo: 12_000_000, rating: 4.4, reviews: 73, badge: 'standard', established: 2012, hue: 90, facilities: ['Montessori rooms', 'Garden', 'Music room'], vacancies: [], scholarships: [], specialNeeds: true },
  { id: 'wellington', name: 'Wellington Grammar School', tagline: 'Tradition and ambition', location: 'Ikoyi, Lagos', type: 'Secondary', gender: 'Boys', boarding: 'Day & Boarding', feeFromKobo: 52_000_000, rating: 4.9, reviews: 142, badge: 'premium', established: 1996, hue: 145, facilities: ['Rugby pitch', 'Observatory', 'Debate hall', 'Labs'], vacancies: [{ title: 'Physics Teacher', dept: 'Academics' }], scholarships: [{ title: 'Founders Scholarship', value: '50% tuition' }], reviews_list: [{ stars: 5, text: 'A school with real tradition and ambition. Excellent results.', anon: false, by: 'Parent · JSS 3' }] },
];
...
export const topRated = () => [...SCHOOLS].sort((a, b) => b.rating - a.rating).slice(0, 4);
export const withScholarships = () => SCHOOLS.filter((s) => s.scholarships.length > 0);
export const hiring = () => SCHOOLS.filter((s) => s.vacancies.length > 0);
export const specialNeedsSchools = () => SCHOOLS.filter((s) => s.specialNeeds);

...
export default function SNPostVacancy() {
  ...
  const handlePost = async () => {
    ...
    try {
      ...
      setSubmitError('We could not submit this vacancy. Check your connection and try again.');
    } finally {
      setSubmitting(false);
    }
  };
    ...
    <div style={{ minHeight:'100vh', background:T.bg, fontFamily:T.font }}>
      ...
      <div style={{ maxWidth:720, margin:'40px auto', padding:'0 24px' }}>
        <div style={{ background:T.cardBg, borderRadius:T.cardR, border:`1.5px solid ${T.cardBorder}`, padding:'32px' }}>
          ...
          {submitError && <div role="alert" style={{ marginBottom:14, color:'#B91C1C', fontSize:13, fontWeight:700 }}>{submitError}</div>}

...
export default function Home() {
  return (
    <>
      ...
      <Strip eyebrow="Top rated" title="Highly rated schools" schools={topRated()} seeMore="/?sort=rating" />
      <Strip eyebrow="Affordable" title="Schools offering scholarships" schools={withScholarships()} seeMore="/?scholarships=1" badgeText={(s) => s.scholarships[0]?.title ?? ''} />
      ...
      <Strip eyebrow="Inclusive" title="Special-needs friendly" schools={specialNeedsSchools()} seeMore="/?special_needs=1" />
